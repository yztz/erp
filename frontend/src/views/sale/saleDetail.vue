<template>
  ...
  >
    <el-row>
      ...
      <el-col class="value" :span="6">{{ saleTime }}</el-col>
      <el-col></el-col>
    </el-row>
...
import { queryStockByID } from '@/api/stock'
...
export default {
  ...
  methods: {
    ...
    updateComment() {
      updateSaleCollection(this.item.id, this.item).then(res=>{
        console.log(res)
